    ...
    */
    private function createEditForm(ScanHistory $entity)
    {
        $form = $this->createForm(new ScanHistoryType(), $entity, array(
            'action' => $this->generateUrl('scanhistory_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('scanhistory_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('scanhistory'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('scanhistory_delete', array('id' => $id)))
            ->setMethod('DELETE')
