...
class NetworkController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('network_show', array('id' => $entity->getId())));
        }

        return $this->render('AppBundle:Network:new.html.twig', array(
            'entity' => $entity,
    ...
    /**
     * Creates a form to create a Network entity.
     *
     * @param Network $entity The entity
     *
     * @return \Symfony\Component\Form\Form The form
     */
    private function createCreateForm(Network $entity)
    {
        $form = $this->createForm(new NetworkType(), $entity, array(
            'action' => $this->generateUrl('network_create'),
            'method' => 'POST',
        ));
