...
class ImportController extends Controller
{
    ...
    public function importAction(Request $request) {
        ...
        if($request->getContent() == '') {
            return new Response('Empty request body!', Response::HTTP_NOT_FOUND);
        }
        ...
        if(!$this->get("app.composition_controller")->storeFromXML($xml)) {
            return new Response('XML could not be converted into an object!', Response::HTTP_NOT_IMPLEMENTED);
        }
